  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Animated.ScrollView
        ...
        <ImageBackground
          source={{uri: IMG_URI + state?.backdrop_path}}
          blurRadius={1}
          style={{width: '100%', height: normalize(230)}}
          resizeMode={'cover'}>
          {/*<LinearGradient*/}
        ...
        <Animated.View entering={FadeInDown.duration(1000)}>
          {isLoading ? (
            <HeaderFilmSkeleton enabled={isLoading} />
          ) : (
            <View style={styles.block}>
              <View style={styles.titleBlock}>
                <View>
                  ...
                  <Text
                    ...
                    <Text style={{color: themeColors[appTheme].dotColor}}>
                      ●
                    </Text>{' '}
                    {state?.runtime} m
                  </Text>
                  <TouchableOpacity
                    ...
                    <FontAwesome5
                      name={'play'}
                      color={themeColors[appTheme].dotColor}
                ...
                <Image
                  source={{uri: IMG_URI + state?.poster_path}}
                  style={styles.poster}
                  resizeMode="contain"
                />
              </View>
              ...
              <View style={{flex: 1, paddingTop: normalize(20)}}>
                <Text style={{...styles.tagline, fontSize: normalize(18)}}>
                  {i18n.t('ratings')}:
                </Text>
                <View style={{width: '100%', marginTop: normalize(15)}}>
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    <Text style={styles.text}>
                      {' '}
                      TMDB:{' '}
                      <Text style={styles.rateText}>{state?.vote_average}</Text>
                    </Text>
                  </View>
                  {ratingData?.rating && (
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
              ...
              {reviewsData?.reviewsAll?.length > 0 && (
                <View
                  style={{
                  ...
                  {reviewsData?.reviewsAll?.length < 4 && (
                    <TouchableOpacity
                      onPress={() =>
                        navigation.navigate('FilmReviews', {
                          id: id,
                          title: state.title,
                        })
                      }>

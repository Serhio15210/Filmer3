...
const Signup = ({navigation}) => {
  ...
  const [translateY, setTranslateY] = useState(
    new Animated.Value(normalize(300)),
  );
  const [paddingBottom, setPaddingBottom] = useState(
    new Animated.Value(normalize(45)),
  );
  ...
  return (
    <View
      ...
      <ScrollView>
        <KeyboardAvoidingView
          style={{
            backgroundColor: isDarkTheme ? '#333333' : '#333333',
            flex: 1,
          }}
          behavior="padding"
          enabled>
          ...
          <View style={style.field}>
            <TouchableOpacity
              ...
              disabled={!email || !username || !rePassword || !password}
              style={{
                ...style.button,
                backgroundColor:
                  !email || !username || !rePassword || !password
                    ? 'black'
                    : isDarkTheme
                    ? '#DAA520'
                    : '#DC143C',

...
const EditList = ({route}) => {
  ...
  const [editList, {isLoading: isUpdating, isSuccess, error}] =
    userApi.useUpdateListMutation();
  const [deleteList, {isLoading: isDeleting, isSuccess: isDeleted}] =
    userApi.useDeleteListMutation();
    ...
    <ScrollView>
      <View style={styles.container}>
              ...
              <>
                ...
                <View style={styles.form}>
                  <View style={{gap: -10}}>
                    <Text
                      style={{
                        color: isDarkTheme ? MAIN_GREY_SKELETON : 'black',
                      }}>
                      List Name
                    </Text>
                    <TextInput
                      style={{
                        ...styles.input,
                        borderColor: values.name ? 'white' : MAIN_GREY_SKELETON,
                      }}
                      placeholder={'...'}
                  ...
                  <View style={{gap: -10}}>
                    ...
                    <TextInput
                      style={{
                        ...styles.input,
                        borderColor: values.description
                          ? 'white'
                          : MAIN_GREY_SKELETON,
                      }}
                      placeholder={'...'}
        ...
        <TouchableOpacity
          ...
          />
          <Text style={{...styles.text, padding: 10}}>Edit Entries...</Text>
          <FlatList
            data={tempFilms}
